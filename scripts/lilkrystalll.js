...
artists[0] = new slide('../../assets/image/kristall1000x500(2).png'); artistJS.append(artists[0].slide_div);
artists[1] = new slide('../../assets/image/kristall1000x500(1).png'); artistJS.append(artists[1].slide_div);
artists[2] = new slide('../../assets/image/kristall1000x500(3).png'); artistJS.append(artists[2].slide_div);
