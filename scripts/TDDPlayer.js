...
const songs = ['МУККА, Три дня дождя-Не выводи меня','Три дня дождя-Беги от меня','Три дня дождя-Привычка']

let songIndex = 0;

function loadSong(song){
    title.innerHTML = song
    cover.src = `../../assets/image/cover${songIndex+7}.jpg`
...
function pauseSong(){
    HeadTitle.innerHTML = "Три дня дождя"
