...
const songs = ['T-Fest feat. Баста - Скандал','T-Fest & Скриптонит - Ламбада','T-Fest - Не Для Меня']

let songIndex = 0;

function loadSong(song){
    title.innerHTML = song
    cover.src = `../../assets/image/cover${songIndex+13}.jpg`
